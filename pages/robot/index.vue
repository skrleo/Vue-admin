        ...
        <div class="robot-card">
            <div class="robot-setting">
                ...
                <div class="robot-info">
                    ...
                    <span style="line-height:38px;">微信号: <el-link type="primary">{{checkLoginInfo.Alias}}</el-link></span>
                    <br/>
                    ...
                    <span><el-button type="text">设置微信号</el-button></span>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        heartBeat(wxId){
            var _this = this
            axios.post('/admin/robot/login/heartBeat',qs.stringify({
                wxId: wxId,
            }))
            .then(res => {
                setTimeout(function()  {
